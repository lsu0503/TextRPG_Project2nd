...
{
    internal class EliteWolf : ICharacter, IMonster
    {
        ...
        int emberDrop = 40;
        int amberDrop = 40;
        List<ItemDrop> itemDropList = new List<ItemDrop>() { new ItemDrop(new SoulStoneFragment(), 0.45f) };
        int expDrop = 40;
